...
class DataHandler:
    ...
    def write_data(self, pandas_dataset, catalog_name, schema_name, table_name):
        """
    ...
    def normalize_column_names(self, pandas_dataset):
        ...
        normalized_columns = [re.sub(r"\s+", "_", col.lower()).strip() for col in pandas_dataset.columns]
